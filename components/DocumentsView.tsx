...
interface DocumentsViewProps {
  documents: Document[];
  user: User;
  onAddDocument: (doc: Omit<Document, 'id' | 'createdAt' | 'tenantId' | 'uploaderId' | 'uploaderName'>) => Promise<void>;
  onAddVersion: (docId: string, version: Omit<DocumentVersion, 'id' | 'createdAt'>) => Promise<void>;
